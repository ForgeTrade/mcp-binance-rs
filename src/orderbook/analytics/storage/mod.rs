...
//!
//! Storage design (research.md lines 86-90):
...
impl SnapshotStorage {
    ...
    pub fn new<P: AsRef<Path>>(path: P) -> Result<Self> {
        ...
        // Compression (Zstd for best ratio, research.md line 44)
    ...
    /// # Example
    /// ```no_run
    /// # use mcp_binance_server::orderbook::analytics::storage::SnapshotStorage;
    /// # async fn example() -> anyhow::Result<()> {
    /// let storage = SnapshotStorage::new("./data/snapshots")?;
    /// storage.put("BTCUSDT", 1737158400, &snapshot_data).await?;
    /// # Ok(())
    /// # }
    /// ```
