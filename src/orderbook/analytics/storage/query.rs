...
/// # Example
/// ```no_run
/// # use mcp_binance_server::orderbook::analytics::storage::*;
/// # async fn example(storage: SnapshotStorage) -> anyhow::Result<()> {
/// let start = 1737158400; // Unix timestamp
/// let end = 1737158460;   // +60 seconds
/// let snapshots = query_snapshots_in_window(&storage, "BTCUSDT", start, end).await?;
